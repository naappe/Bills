...
const uniqueBillNumber=row=>`B-${String(row?.id||0).padStart(6,'0')}`;
...
window.renderBills=function(){
 ...
 $('#content').innerHTML=pageHead('Bills','All bills with a permanent unique entry number, bill date and added timestamp.',actions)+`
