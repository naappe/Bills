...
export function billsPage(){
  ...
  <section class="card"><div class="table-wrap"><table class="table bills-table"><thead><tr><th>#</th><th>Bill date / last edit</th><th>Descriptions</th><th>Product / pack</th><th>Vendor</th><th class="num">Amount</th><th>Bill created date</th><th class="action-col">Actions</th></tr></thead><tbody id="billRows"></tbody></table></div><footer class="pager"><span id="pageMeta"></span><div class="actions"><button class="btn secondary small" id="prevPage">Previous</button><button class="btn secondary small" id="nextPage">Next</button></div></footer></section>`;
