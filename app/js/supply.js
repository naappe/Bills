...
function styles(){
  ...
  style.textContent=`
  .supply-toolbar{display:flex;gap:10px;align-items:end;justify-content:space-between;flex-wrap:wrap;margin-bottom:14px}.supply-toolbar label{min-width:min(340px,100%)}
  .supply-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));gap:14px}.supply-card{padding:16px;border:1px solid var(--border);border-radius:16px;background:var(--surface);display:grid;gap:12px}.supply-card h3{margin:0;color:var(--text-strong);font-size:16px}.supply-card p{margin:0;color:var(--text-muted);font-size:12px}.supply-stock{display:flex;align-items:end;justify-content:space-between;gap:12px}.supply-stock strong{font-size:25px}.supply-meta{display:grid;grid-template-columns:1fr 1fr;gap:8px}.supply-meta div{padding:9px;border-radius:10px;background:var(--surface-muted)}.supply-meta span{display:block;color:var(--text-muted);font-size:10px;text-transform:uppercase}.supply-meta strong{display:block;margin-top:3px;font-size:12px}.stock-badge{display:inline-flex;width:max-content;padding:5px 9px;border-radius:999px;font-size:11px;font-weight:700}.stock-badge.success{background:#e8f7ef;color:#16734a}.stock-badge.warning{background:#fff4d8;color:#9a6700}.stock-badge.danger{background:#feeceb;color:#b42318}.supply-empty{padding:38px;text-align:center;color:var(--text-muted)}
  `;
