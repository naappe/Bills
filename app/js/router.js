...
import {billsPage} from './bills.js?v=5.8.1';
import {supplyPage,inventoryPage} from './supply.js?v=5.8.1';
import {costPage} from './cost.js?v=5.8.1';
import {reportsPage} from './reports.js?v=5.8.1';
import {adminPage} from './admin.js?v=5.8.1';
