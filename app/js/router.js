...
import {settingsPage} from './settings.js?v=4.9.48';
import {newBillPage} from './bill-entry.js?v=4.9.48';
import {billsPage} from './bills.js?v=4.9.48';
import {productsPage} from './products.js?v=4.9.48';
import {vendorsPage} from './vendors.js?v=4.9.48';
import {ratesPage} from './rates.js?v=4.9.48';
import {reportsPage} from './reports.js?v=4.9.48';
import {adminPage} from './admin.js?v=4.9.48';
