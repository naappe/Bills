...
import {watchSharedUI} from './ui.js?v=5.9.2';
import {dashboardPage} from './dashboard.js?v=5.9.2';
import {settingsPage} from './settings.js?v=5.9.2';
import {newBillPage} from './bill-entry.js?v=5.9.2';
import {billsPage} from './bills.js?v=5.9.2';
import {supplyPage,inventoryPage} from './supply.js?v=5.9.2';
import {costPage} from './cost.js?v=5.9.2';
import {reportsPage} from './reports.js?v=5.9.2';
import {adminPage} from './admin.js?v=5.9.2';
