...
import {dashboardPage} from './dashboard.js?v=4.9.55';
import {settingsPage} from './settings.js?v=4.9.55';
import {newBillPage} from './bill-entry.js?v=4.9.55';
import {billsPage} from './bills.js?v=4.9.55';
import {productsPage} from './products.js?v=4.9.55';
import {vendorsPage} from './vendors.js?v=4.9.55';
import {ratesPage} from './rates.js?v=4.9.55';
import {reportsPage} from './reports.js?v=4.9.55';
import {adminPage} from './admin.js?v=4.9.55';
