...
import {startRouter} from './router.js?v=4.9.31';
...
const health={version:'4.9.31',booted:false,authenticated:false,dataLoaded:false,error:null,startedAt:new Date().toISOString()};
