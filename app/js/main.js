...
import {startRouter,navigate} from './router.js?v=5.9.4';
...
const health={version:'5.9.4',booted:false,authenticated:false,dataLoaded:false,error:null,runtimeErrors:[],startedAt:new Date().toISOString()};
