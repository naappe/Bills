...
import {startRouter,navigate} from './router.js?v=5.3.0';
...
const health={version:'5.3.0',booted:false,authenticated:false,dataLoaded:false,error:null,runtimeErrors:[],startedAt:new Date().toISOString()};
