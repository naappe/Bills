...
import {startRouter} from './router.js?v=4.9.34';
import './vendor-picker.js?v=4.9.34';
import './bill-entry-cleanup.js?v=4.9.34';
...
const health={version:'4.9.34',booted:false,authenticated:false,dataLoaded:false,error:null,startedAt:new Date().toISOString()};
