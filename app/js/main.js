...
import {startRouter,navigate} from './router.js?v=5.4.1';
...
const health={version:'5.4.1',booted:false,authenticated:false,dataLoaded:false,error:null,runtimeErrors:[],startedAt:new Date().toISOString()};
