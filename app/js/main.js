...
import {startRouter} from './router.js?v=4.9.32';
import './vendor-picker.js?v=4.9.29';
import './bill-entry-cleanup.js?v=4.9.33';
...
const health={version:'4.9.33',booted:false,authenticated:false,dataLoaded:false,error:null,startedAt:new Date().toISOString()};
