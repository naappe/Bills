...
import {startRouter,navigate} from './router.js?v=5.9.5';
...
const health={version:'5.9.5',booted:false,authenticated:false,dataLoaded:false,error:null,runtimeErrors:[],startedAt:new Date().toISOString()};
