...
import {startRouter} from './router.js?v=4.9.41';
import './vendor-picker.js?v=4.9.41';
import './product-image-ui.js?v=4.9.41';
...
const health={version:'4.9.41',booted:false,authenticated:false,dataLoaded:false,error:null,startedAt:new Date().toISOString()};
