...
import {startRouter} from './router.js?v=4.9.39';
import './vendor-picker.js?v=4.9.39';
...
const health={version:'4.9.39',booted:false,authenticated:false,dataLoaded:false,error:null,startedAt:new Date().toISOString()};
