...
import {startRouter} from './router.js?v=4.9.38';
import './vendor-picker.js?v=4.9.38';
...
const health={version:'4.9.38',booted:false,authenticated:false,dataLoaded:false,error:null,startedAt:new Date().toISOString()};
