...
for required_controller in ['loadAuthenticatedBills','stopImmediatePropagation','window.reloadBillsNow','app-controller']:
...
print('Applied stable Bills app with authoritative navigation and authenticated data controller v51.')